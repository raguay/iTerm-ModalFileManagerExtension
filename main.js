var iterm = {
  ...
  open: function() {
    ...
    var extScript = iterm.extMan.getExtensionDir() + '/iTerm-ModalFileManagerExtension/iterm.scpt';
    //
    // Use AppleScript command line to open the cursor in iterm.
    //
    iterm.extMan.getLocalFS().runCommandLine('osascript "' + extScript + '" "' + cursor.entry.dir + '"');
